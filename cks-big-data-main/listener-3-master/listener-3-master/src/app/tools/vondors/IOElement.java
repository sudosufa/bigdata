...
public class IOElement {
     ...
     *
     * @param codecInputStream Input stream to read from
     * @return Returns read io element
     * @throws IOException Thrown by passed input stream, or if unable to build io data
     *                     from input stream
     */
     ...
     *
     * @param codecOutputStream Output stream to write to
     * @param ioElement         Io element to write
     ...
     *
     * @param propertyId Id Of property whose value is needed
     ...
     * @param overwrite Do owervrite values if present in this element
     */
